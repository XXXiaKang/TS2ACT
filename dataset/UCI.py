...
def UCI_TS2ACT_aug(shot = 10 ,dataset_dir='/home/xiakang/data/UCI-HAR',name="10-shot",clip_len = 500):
...
def test():
    ...
    torch.save(text_features,"/home/xiakang/data/UCI-HAR/UCI HAR Dataset/UCI_text.pth")
    save = []
    for label in labels:
        images = []
        for i in range(50):
            images.append(preprocess(Image.open('/home/xiakang/data/UCI-HAR/UCI HAR Dataset/'+label+'/' + 
                str(i+1)+".jpg")))
    ...
    torch.save(image_features,"/home/xiakang/data/UCI-HAR/UCI HAR Dataset/UCI_image.pth")
